...
<body>   
    ...
    <table rules>
        ...
        <tbod>
            <?php
            $sql_consulta = mysqli_query($mysqli, "SELECT e.nome_empresa, Id_linha, l.cod_linha, l.nome_linha, l.tipo_linha FROM linha AS l JOIN empresa AS e ON l.id_empresa = e.id_empresa $filtro_sql ORDER BY cod_linha ASC");
